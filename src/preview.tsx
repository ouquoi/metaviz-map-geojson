...
const MOCK_LINES = [
  { nom_ligne: "Métro Ligne A — Basso-Cambo / Balma-Gramont", ligne: "A",   mode: "metro", color: "#FF0000",
  ...
  { nom_ligne: "Métro Ligne B — Borderouge / Ramonville",       ligne: "B",   mode: "metro", color: "#0064C8",
  ...
  { nom_ligne: "Tram T1 — Arènes / Beauzelle",                  ligne: "T1",  mode: "tram",  color: "#00A046",
  ...
  { nom_ligne: "Tram T2 — Palais de Justice / Médiathèque",     ligne: "T2",  mode: "tram",  color: "#C88200",
  ...
  { nom_ligne: "Bus L1 — Colomiers / Fenouillet",               ligne: "L1",  mode: "bus",   color: "#8C008C",
  ...
  { nom_ligne: "Bus 101 — Balma / Mondouzil",                   ligne: "101", mode: "bus",   color: "#800080",
  ...
  { nom_ligne: "Bus 37 — Université / Labège",                  ligne: "37",  mode: "bus",   color: "#C85000",
...
const MOCK_SERIES = [
  {
    data: {
      cols: [
        ...
        { name: "color",     display_name: "Color",     base_type: "type/Text" },
      ],
      rows: MOCK_LINES.map(l => [l.geometry, l.nom_ligne, l.ligne, l.mode, l.color]),
    },
  },
];
